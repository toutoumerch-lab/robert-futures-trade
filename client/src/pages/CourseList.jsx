  ...
  return (
    <div>
      ...
      <section className="page-hero" style={{ padding: '6rem 0', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container text-center" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ color: 'var(--text-secondary)', maxWidth: '600px', margin: '0 auto', fontSize: '1.15rem', lineHeight: 1.6 }}>
            Structured, in-depth frameworks engineered by Robert â€” scaling from fundamental price action structures directly to advanced prop firm liquidity management.
          </p>
        </div>
      </section>
      ...
      <div className="container" style={{ paddingBottom: '6rem' }}>
        ...
        {loading ? (
          <div className="loading-state" style={{ padding: '4rem', textAlign: 'center', color: 'var(--text-secondary)' }}>Loading course matrixâ€¦</div>
        ) : courses.length === 0 ? (
          <div className="empty-state-page" style={{ textAlign: 'center', padding: '6rem 2rem', background: 'var(--bg-secondary)', borderRadius: '32px', border: '1px dashed var(--border)', maxWidth: '800px', margin: '0 auto' }}>
            <p style={{ fontSize: '4rem', marginBottom: '1.5rem' }}>ðŸ“š</p>
                 ...
                 >
                   ...
                   <div style={{ padding: '2rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
                     <div style={{ display: 'flex', gap: '8px', marginBottom: '1.25rem', flexWrap: 'wrap' }}>
                       ...
                       <span style={{ fontSize: '0.75rem', background: 'var(--bg-primary)', padding: '6px 14px', borderRadius: '99px', color: 'var(--text-secondary)', fontWeight: 700, border: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: '4px' }}>â± {course.duration || 'N/A'}</span>
                     </div>
