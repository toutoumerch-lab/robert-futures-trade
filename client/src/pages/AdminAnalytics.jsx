...
/* ─── constants ─────────────────────────────────────────────── */
const API = `${import.meta.env.VITE_API_URL}/api/admin/analytics`;
const RANGES = [
                    ...
                    <tr key={f.id} style={{borderBottom:'1px solid rgba(255,255,255,0.04)'}}
                      ...
                      <td style={{padding:'12px 14px'}}>
                        <div style={{display:'flex',alignItems:'center',gap:'10px'}}>
                          {f.logoUrl && <img src={`${import.meta.env.VITE_API_URL}${f.logoUrl}`} alt="" style={{width:'32px',height:'32px',borderRadius:'8px',objectFit:'contain',background:'#fff',padding:'3px',flexShrink:0}}/>}
                          <div>
